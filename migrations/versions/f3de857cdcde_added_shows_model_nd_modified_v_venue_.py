"""Added shows  model nd modified v venue and artist tablenames

Revision ID: f3de857cdcde
Revises: 8976edd269d4
Create Date: 2022-05-27 20:25:48.459966
...
revision = 'f3de857cdcde'
down_revision = '8976edd269d4'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('image_link', sa.String(length=500), nullable=True),
    sa.Column('facebook_link', sa.String(length=120), nullable=True),
    sa.Column('genres', sa.String(length=80), nullable=True),
    sa.Column('website_link', sa.String(length=120), nullable=True),
